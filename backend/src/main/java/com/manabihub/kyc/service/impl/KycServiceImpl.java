...
public class KycServiceImpl implements KycService {
    ...
    public List<KycRequestResponse> getPendingKycQueue(UUID adminId) {
        ...
        // UC-28 keeps pending submissions reviewable while approved records remain
        // available for post-approval investigation and revocation.
        List<KycRequest> requests = kycRequestRepository.findByStatusInOrderByCreatedAtDesc(
                List.of(KycRequestStatus.PENDING, KycRequestStatus.APPROVED)
        );
